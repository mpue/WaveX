    ...
    */
    ...
    public:
                                                    ...
                                                    DocumentWindow::allButtons)
        {
            ...
            // LookAndFeel::setDefaultLookAndFeel(&clf);
            
            appWindow = new AppWindowComponent();
            setContentOwned (appWindow, true);
    ...
    private:
        ScopedPointer<AppWindowComponent> appWindow;
...
START_JUCE_APPLICATION (WaveXApplication)
